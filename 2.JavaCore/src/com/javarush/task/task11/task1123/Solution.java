...
* В поле х этого объекта должно содержаться минимальное число, а в поле у максимальное число из массива inputArray
*/
...
public class Solution {
    ...
    public static Pair getMinimumMaximumPair(int[] inputArray) {
        ...
        return new Pair(minimum, minimum);
    }
    ...
    public Integer y;
        ...
        public Pair(Integer x, final Integer y) {
            this.x = x;
            this.y = y;
        }
    }
