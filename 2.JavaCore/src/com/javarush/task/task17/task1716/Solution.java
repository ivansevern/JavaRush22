...
public class Solution {
    ...
    synchronized double method3() { //add synchronized
        double random = Math.random();
        param += 40.7;
        return random + param;
    }

    private synchronized void method4() { //add synchronized
    ...
    public synchronized String method6(int param2) { //add synchronized
