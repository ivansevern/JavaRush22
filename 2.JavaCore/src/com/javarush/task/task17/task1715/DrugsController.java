...
public class DrugsController {
    ...
    public synchronized void buy(Drug drug, int count) { //public void -> public synchronized void
    ...
    public synchronized void sell(Drug drug, int count) { //public void -> public synchronized void
