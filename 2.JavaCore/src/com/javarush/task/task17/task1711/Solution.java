...
public class Solution {
    ...
    static {
        allPeople.add(Person.createFemale("Иванов Иван", new Date()));
        allPeople.add(Person.createFemale("Петров Петр", new Date()));
    }
                ...
                case "-i":
                    synchronized (allPeople) {
                        for (int i = 1; i < args.length; i++) {
                            ...
                            System.out.println(person.getSex().equals(Sex.MALE) ? "ж" : "м");
